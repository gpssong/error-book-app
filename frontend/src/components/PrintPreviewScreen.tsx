  ...
  return (
    <div className="flex flex-col h-full bg-[#F8FAFC]" style={{ fontFamily: "'Nunito', sans-serif" }}>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4">
        {/* A4 preview */}
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden print:shadow-none" style={{ border: '1px solid #E2E8F0' }}>
          {/* A4 header */}
        ...
        {/* Print settings */}
        <div className="mt-4 bg-white rounded-2xl p-4 shadow-sm space-y-3">
        ...
        <button
          onClick={handlePrint}
          className="w-full mt-4 mb-4 py-4 rounded-2xl text-white font-extrabold text-sm flex items-center justify-center gap-2 shadow-lg"
